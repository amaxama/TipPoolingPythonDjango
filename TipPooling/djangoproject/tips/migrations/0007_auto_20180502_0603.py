# Generated by Django 2.0.4 on 2018-05-02 06:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_hours', models.DecimalField(decimal_places=3, default=Decimal('0.000'), max_digits=6)),
            ],
        ),
        migrations.CreateModel(
            name='Location',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hours', models.DecimalField(decimal_places=3, default=Decimal('0.000'), max_digits=6)),
                ('day_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tips.Day')),
                ('employee_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tips.Employee')),
            ],
        ),
        ...
        migrations.RemoveField(
            model_name='tips',
            name='w7_Mon_Cash_Tips',
        ),
        migrations.RemoveField(
            model_name='tips',
            name='w7_Mon_Cash_Tips_currency',
        ),
        migrations.RemoveField(
            model_name='tips',
            name='w7_Mon_Cred_Tips',
        ),
        migrations.RemoveField(
            model_name='tips',
            name='w7_Mon_Cred_Tips_currency',
        ),
        migrations.RemoveField(
            model_name='tips',
        ...
        migrations.RemoveField(
            model_name='tips',
            name='wee_Mon_Cash_Tips_currency',
        ),
        migrations.RemoveField(
            model_name='tips',
        ...
        migrations.RemoveField(
            model_name='tips',
            name='wee_Mon_Cred_Tips_currency',
        ),
        migrations.AddField(
            model_name='location',
            name='tip_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tips.Tips'),
        ),
        migrations.AddField(
            model_name='day',
            name='location_id',
